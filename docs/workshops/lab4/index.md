...
| Section | Description |
|---------|-------------|
| 4.2 Dashboards | Create and customize dashboards |
| 4.3 Notebooks | Build interactive notebooks |
| 4.4 Analyze Data | Import and use pre-built notebooks |
| 4.5 Summary | Review what you accomplished |
